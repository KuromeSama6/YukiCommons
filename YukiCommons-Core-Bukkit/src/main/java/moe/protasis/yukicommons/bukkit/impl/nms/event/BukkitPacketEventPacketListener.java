package moe.protasis.yukicommons.bukkit.impl.nms.event;
...
public class BukkitPacketEventPacketListener implements IPacketEventPacketListener, PacketListener {
    private final Map<PacketTypeCommon, Set<RegisteredNMSPacketHandler>> packetListeners = new ConcurrentHashMap<>();

    public BukkitPacketEventPacketListener() {
